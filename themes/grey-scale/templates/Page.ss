...
<head>
    ...
    <% base_tag %>
    $MetaTags(false)
    <title>Matthew Bullock - Web Developer</title>
    ...
    <link href="$ThemeDir/css/Preloader.css" rel="stylesheet">
    ...
    <link href="$ThemeDir/css/Nav.css" rel="stylesheet">
    <link href="$ThemeDir/css/Tabs.css" rel="stylesheet">
    ...
    $(".video-bg").wallpaper({
        source: {
            mp4: "$ThemeDir/mp4/test2.mp4",
             poster: "$ThemeDir/img/back-up-home-pg.png"
        }
    });
    </script>
